...
public class InterfazTransfer extends JFrame {
    ...
    public InterfazTransfer(String nC) {
        setSize(700, 500);
    ...
    private void colocarEtiquetas() {
        ...
        e1.setText("Ingrese Cuenta Destino");
    ...
    private void colocarBotones() {
        ...
        ingresar = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent q) {
                ...
                if (h == 0) {
                    e2.setText("Este numero no pertenece a ninguna cuenta");
                }
                else{
                    InterfazTMonto itm=new InterfazTMonto(nc,nc1);
                    itm.setVisible(true);
                    setVisible(false);
                }
